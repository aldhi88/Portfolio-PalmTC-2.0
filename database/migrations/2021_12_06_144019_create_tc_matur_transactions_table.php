...
class CreateTcMaturTransactionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tc_matur_transactions', function (Blueprint $table) {
            $table->id();
            $table->bigInteger('tc_init_id');
            $table->bigInteger('tc_matur_bottle_id');
            $table->bigInteger('tc_matur_ob_id')->nullable();
    ...
    {
        Schema::dropIfExists('tc_matur_transactions');
    }
}
