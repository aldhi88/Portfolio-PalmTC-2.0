...
class CreateTcHardenObDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tc_harden_ob_details', function (Blueprint $table) {
            $table->id();
            $table->bigInteger('tc_init_id');
            $table->bigInteger('tc_harden_tree_id');
    ...
    {
        Schema::dropIfExists('tc_harden_ob_details');
    }
}
