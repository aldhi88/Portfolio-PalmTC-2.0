<form id="formTransferModal"> @csrf
    <input type="hidden" name="tc_aclim_ob_id">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="row">
                <div class="col">
                    <h5>Aclim Date: <span id="aclim-date"></span></h5>
                </div>
                <div class="col">
            ...
            <div class="row">
                <div class="col">
                    <div class="form-group">
                        <label class="font-weight-bold">Back to Aclim</label>
                        <input type="number" value="0" min="0" class="form-control form-control-sm" name="to_self">
                    </div>
                </div>
                <div class="col">
                    <div class="form-group">
                        <label class="font-weight-bold">Transfer to Hardening</label>
