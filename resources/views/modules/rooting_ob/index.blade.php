...
@section('css')
@include('modules.rooting_ob.include.index_css')
@endsection

@section('js')
@include('modules.rooting_ob.include.index_js')
@endsection
            ...
            <div class="card-body">
                <table id="myTable" class="table table-striped table-bordered nowrap table-xs w-100">
                    <thead>
                        <tr>
                            <th>Sample</th>
                            <th>Total<br>Plantlet</th>
                            <th>Obs<br>Count</th>
                            <th>Plantlet<br>Rooting</th>
                            <th>Plantlet<br>Oxidate</th>
                            <th>Plantlet<br>Contam</th>
                            <th>Plantlet<br>Other</th>
                        </tr>
                    </thead>
