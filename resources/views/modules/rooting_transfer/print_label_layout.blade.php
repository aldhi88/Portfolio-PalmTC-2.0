                            ...
                            <td class="border p-3" style="width:{{ $tdWidth }}%">
                                ...
                                <div class="row">
                                    <div class="col-8 px-1">
                                        <p class="my-0 py-0">Embryogenesis</p>
                                        <p class="my-0 py-0">
                                            {{ $data["transfer"][$index]['medium_code'] }}/{{$data["transfer"][$index]['alpha']}}/{{ $data["transfer"][$index]['worker_code'] }}
                                        </p>
                                        <p class="my-0 py-0">
                                            {{ $data["transfer"][$index]['tahuntanam'] }}/{{ $data["transfer"][$index]['program'] }}
                                        </p>
                                        <p class="my-0 py-0">
                                            {{ $data["transfer"][$index]['noseleksi'] }}
                                        </p>
                                    </div>
                                    <div class="col text-right pr-1 pl-0">
                                        {!! 
                                            QrCode::size(75)->generate(
                                                $data["transfer"][$index]['sample_number'] .'-SC1-'
                                            ); 
                                        !!}
                                    </div>
                                </div>
