    ...
    <div class="row">
        <div class="form-group col">
            ...
            <div class="input-group">
                ...
                <div class="input-group-append">
                    <input type="number" name="leaf_count" min="0" value="{{ $dtSession['leaf_count'] }}" class="form-control form-control-sm px-2 border">
                </div>
            </div>
        </div>
        <div class="form-group col">
            ...
            <div class="input-group">
                <input type="number" readonly="" name="to_root2" value="{{ $dtSession['to_root2'] }}" class="form-control form-control-sm px-2">
                <div class="input-group-append">
        ...
        <div class="form-group col">
            ...
            <div class="input-group">
                <input type="number" name="to_next" value="{{ $dtSession['to_next'] }}" class="form-control form-control-sm px-2">
            </div>
        </div>
