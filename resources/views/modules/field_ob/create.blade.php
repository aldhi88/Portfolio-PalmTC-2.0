...
@section('css')
@include('modules.field_ob.include.create_css')
@endsection

@section('js')
@include('modules.field_ob.include.create_js')
@endsection
    ...
    <div class="col">
        ...
        <div class="card">
            ...
            <div class="card-header">
                <div class="row">
                    <div class="col">
                        <a href="{{ route('field-obs.index') }}" class="btn btn-warning btn-sm"><i class="fas fa-backward mr-2"></i>All Data</a>
                        <a href="{{ route('field-obs.show',$data['initId']) }}" class="btn btn-warning btn-sm"><i class="fas fa-backward mr-2"></i>Detail</a>
                        <span class="ml-3">
                ...
                <div class="row {{ !$data['start']?'d-none ':null }}" id="table-wrap">
                    <div class="col">
                        <table id="myTable" class="table table-striped table-bordered nowrap table-xs w-100">
                            <thead>
                                <tr>
                                    <th rowspan="2">Harden<br>Date</th>
                                    <th rowspan="2">Number</th>
                                    <th colspan="3" class="text-center">Form Observation</th>
                                </tr>
                                <tr>
                                    <th>Death</th>
                                    <th>Normal<br>Abnormal</th>
                                    <th width="100">Production<br>Load</th>
                                </tr>
                            </thead>
