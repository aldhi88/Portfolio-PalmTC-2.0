...
var columns = [
    ...
    { data: 'field_count', name: 'field_count', orderable:false, searchable:true},
    ...
    { data: 'field_active', name: 'field_active', orderable:false, searchable:true},
];
