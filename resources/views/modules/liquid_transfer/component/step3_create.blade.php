...
<form id="createStep3">@csrf
    ...
    <div class="row">
        <div class="form-group col">
            <label class="font-wight-bold">To Liquid</label>
...
@include('modules.liquid_transfer.component.include.step3_create_js')
@include('modules.liquid_transfer.component.include.modal')