...
var columns = [
    ...
    { data: 'harden_count', name: 'harden_count', orderable:false, searchable:true},
    ...
    { data: 'harden_active', name: 'harden_active', orderable:false, searchable:true},
];
