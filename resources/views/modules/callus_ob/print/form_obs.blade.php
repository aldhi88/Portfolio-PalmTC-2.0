...
<body>
    <table class="minimalistBlack">
        <thead>
            ...
            <tr>
                <th><strong>Samplessss: {{ $data['sample_number'] }}</strong></th>
                <th><strong>Number Of: {{ $data['number_of'] }}</strong></th>
                <th><strong>Schedule: {{ $data['schedule'] }}</strong></th>
    ...
    <table class="minimalistBlack" style="margin-top: 10px">
        <thead>
            <tr>
                ...
                <th colspan="{{ $data['explantNumber'] }}">Grow Callus</th>
                <th rowspan="2">Oxidation</th>
                <th rowspan="2">Contamination</th>
            </tr>
            <tr>
                @for ($i=1;$i<=$data['explantNumber'];$i++)
                    <th>{{ $i }}</th>
                @endfor
            </tr>
        </thead>
