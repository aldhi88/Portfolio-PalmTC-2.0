...
@section('css')
@include('modules.germin_transfer.include.create_css')
@endsection

@section('js')
@include('modules.germin_transfer.include.create_js')
@endsection
    ...
    <div class="col">
        <div class="card border border-sm">
            <div class="card-header">
                <div class="row">
                    <div class="col">
                        <a href="{{ route('germin-transfers.show',$data['initId']) }}" class="btn btn-sm btn-warning">
