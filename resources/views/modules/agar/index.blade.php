...
@section('css')
    @include('modules.agar.include.index_css')
@endsection

@section('js')
    @include('modules.agar.include.index_js')
    @include('modules.agar.include.create_js')
    @include('modules.agar.include.edit_js')
    @include('modules.agar.include.delete_js')
@endsection
...
@include('modules.agar.include.modal')
@endsection
