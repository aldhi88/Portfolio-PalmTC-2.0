...
function genStep1(page=null){
    $.ajax({
        ...
        url: '{{ route("liquid-transfers.getStep1") }}',
...
function genStep2(page=null){
    $.ajax({
        type: 'GET', cache: false, contentType: false, processData: true,
        url: '{{ route("liquid-transfers.getStep2") }}',
        data: { page:page,initId:'{{ $data["initId"] }}' },
        success: function(a) {
            $('#step2').html(a);
        },
...
function genStep3(page=null){
    $.ajax({
        type: 'GET', cache: false, contentType: false, processData: true,
        url: '{{ route("liquid-transfers.getStep3") }}',
        data: { page:page,initId:'{{ $data["initId"] }}' },
        success: function(a) {
            $('#step3').html(a);
        },
...
function genStep4(page=null){
    $.ajax({
        type: 'GET', cache: false, contentType: false, processData: true,
        url: '{{ route("liquid-transfers.getStep4") }}',
        data: { page:page,initId:'{{ $data["initId"] }}' },
        success: function(a) {
            $('#step4').html(a);
        },
...
$('#finishTransfer').submit(function (e) {
    ...
    $.ajax({
        type: 'POST',
        url: "{{ route('liquid-transfers.finishTransfer') }}",
        data: formData,
