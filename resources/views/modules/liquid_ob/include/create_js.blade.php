...
<script>
    ...
    function initDt(obsDate = null){
        var dtTable = $('#myTable').DataTable({
            ...
            columns: [
                ...
                { data: 'alpha_cycle', name: 'alpha_cycle', orderable:false, searchable:true},
    ...
    function initSearchColumn(){
        $('#header-filter th').each(function() {
            ...
            if(disable!="true"){
                $(this).html('<input placeholder="'+title+'" type="text" class="form-control text-center column-search px-0 form-control-sm"/>');
            }
        });
