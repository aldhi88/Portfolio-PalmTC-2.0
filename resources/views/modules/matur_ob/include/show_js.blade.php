...
<script>
    ...
    var dtTable = $('#myTable').DataTable({
        ...
        columns: [
            ...
            { data: 'total_bottle_matur', name: 'total_bottle_matur', orderable:true, searchable:true},
    ...
    $('#formDel').submit(function (e) {
        ...
        $.ajax({
            ...
            url: '{{ url("matur-obs") }}/'+formData.get('id'),
            data: formData,
            success: (a) => {
                dtTable.ajax.reload();
    ...
    var dtTable2 = $('#myTable2').DataTable({
        ...
        columns: [
            ...
            { data: 'bottle_date_format', name: 'tc_matur_bottles.bottle_date', orderable:true, searchable:true},
            { data: 'tc_matur_bottles.alpha', name: 'tc_matur_bottles.alpha', orderable:false, searchable:true},
            { data: 'tc_matur_bottles.tc_workers.code', name: 'tc_matur_bottles.tc_workers.code', orderable:false, searchable:true},
            ...
            { data: 'tc_matur_obs.tc_workers.code', name: 'tc_matur_obs.tc_workers.code', orderable:false, searchable:true},
            { data: 'bottle_matur', name: 'bottle_matur', orderable:true, searchable:false},
            ...
            { data: 'last_total', name: 'tc_matur_obs.ob_date', orderable:true, searchable:false},
        ],
        initComplete: function () {
