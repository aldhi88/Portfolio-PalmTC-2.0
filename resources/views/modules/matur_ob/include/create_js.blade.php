...
<script>
    ...
    function initDt(obsDate = null){
        var dtTable = $('#myTable').DataTable({
            ...
            columns: [
                ...
                { data: 'first_total', name: 'bottle_date', orderable:true, searchable:false},
                { data: 'form_matur', name: 'form_matur', orderable:false, searchable:false},
    ...
    function initFormObs(){
        $('body').on('change','input.form-obs',function(){
            ...
            formData.tc_matur_ob_id = '{{ $data["obsId"] }}';
            formData.tc_matur_bottle_id = $(this).attr('data-id');
            ...
            $.ajax({
                ...
                url: '{{ route("matur-obs.storeObDetail") }}',
                data: formData,
                success: function(a) {
                    $('#alert-area2').empty();
