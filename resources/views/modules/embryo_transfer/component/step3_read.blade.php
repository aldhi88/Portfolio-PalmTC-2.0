            ...
            <div class="row">
                <div class="col text-center">
                    <div class="form-group mb-1 border-right">
                        <label><strong>To 58: </strong></label>
                        <span>{{ $dtSession['to_callus'] }}</span>
                    </div>
                </div>
                <div class="col text-center">
                    <div class="form-group mb-1">
                        <label><strong>To Germination: </strong></label>
                        <span>{{ $dtSession['to_solid'] }}</span>
                    </div>
                </div>
                <div class="col text-center">
                    <div class="form-group mb-1">
                        <label><strong>To Liquid: </strong></label>
                        <span>{{ $dtSession['to_suspen'] }}</span>
                    </div>
                </div>
...
@include('modules.embryo_transfer.component.include.step3_read_js')