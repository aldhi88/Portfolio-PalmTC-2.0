...
@section('css')
@include('modules.embryo_transfer.include.create_css')
@endsection

@section('js')
@include('modules.embryo_transfer.include.create_js')
@endsection
    ...
    <div class="col">
        <div class="card border border-sm">
            <div class="card-header">
                <div class="row">
                    <div class="col">
                        <a href="{{ route('embryo-transfers.show',$data['initId']) }}" class="btn btn-sm btn-warning">
