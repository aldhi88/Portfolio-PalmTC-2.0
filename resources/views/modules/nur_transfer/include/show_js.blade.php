...
<script>
    var dtTable = $('#myTable').DataTable({
        ...
        ajax: {
            url: "{{ route('nur-transfers.dtShow') }}",
        ...
        columns: [
            ...
            { data: 'cat_format', name: 'cat', orderable:false, searchable:false},
    ...
    var dtTable2 = $('#myTable2').DataTable({
        ...
        ajax: {
            url: "{{ route('nur-transfers.dtShow2') }}",
            data: {initId:'{{ $data["initId"] }}'}
        },
        columns: [
            ...
            { data: 'to_self2', name: 'to_self2', orderable:true, searchable:false},
...
$("#myTable2").on("click","button.printLabel", function(){
    ...
    window.open('{{ route("nur-transfers.printLabel") }}?id='+transferId+'&type='+type);
})
</script>
