            ...
            <tbody>
                @foreach ($data['bottles'] as $item)
                    ...
                    <tr>
                        ...
                        <td>{{ $item->tc_matur_bottles->alpha }}</td>
                        <td>{{ $bottleLeft }}</td>
                        <td>
                            <form class="addObs">@csrf
                                <input type="hidden" name="id" value="{{ $item->id }}">
                                <input type="hidden" name="bottle_date" value="{{ $item->bottle_date_format }}">
                                <input type="hidden" name="sub" value="{{ $item->tc_matur_bottles->sub }}">
                                <input type="hidden" name="type" value="{{ $item->tc_matur_bottles->type }}">
                                <input type="hidden" name="alpha" value="{{ $item->tc_matur_bottles->alpha }}">
...
@include('modules.matur_transfer.component.include.step2_create_js')