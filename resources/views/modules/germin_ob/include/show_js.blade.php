...
<script>
    ...
    var dtTable = $('#myTable').DataTable({
        ...
        columns: [
            ...
            { data: 'total_bottle_germin', name: 'total_bottle_germin', orderable:true, searchable:true},
    ...
    $('#formDel').submit(function (e) {
        ...
        $.ajax({
            ...
            url: '{{ url("germin-obs") }}/'+formData.get('id'),
            data: formData,
            success: (a) => {
                dtTable.ajax.reload();
    ...
    var dtTable2 = $('#myTable2').DataTable({
        ...
        columns: [
            ...
            { data: 'bottle_date_format', name: 'tc_germin_bottles.bottle_date', orderable:true, searchable:true},
            { data: 'tc_germin_bottles.alpha', name: 'tc_germin_bottles.alpha', orderable:false, searchable:true},
            { data: 'tc_germin_bottles.tc_workers.code', name: 'tc_germin_bottles.tc_workers.code', orderable:false, searchable:true},
            ...
            { data: 'tc_germin_obs.tc_workers.code', name: 'tc_germin_obs.tc_workers.code', orderable:false, searchable:true},
            { data: 'bottle_germin', name: 'bottle_germin', orderable:true, searchable:false},
            ...
            { data: 'last_total', name: 'tc_germin_obs.ob_date', orderable:true, searchable:false},
        ],
        initComplete: function () {
