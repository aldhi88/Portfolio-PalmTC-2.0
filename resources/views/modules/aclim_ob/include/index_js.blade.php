...
var columns = [
    ...
    { data: 'aclim_count', name: 'aclim_count', orderable:false, searchable:true},
    ...
    { data: 'aclim_active', name: 'aclim_active', orderable:false, searchable:true},
];
