...
@section('css')
@include('modules.nur_ob.include.create_css')
@endsection

@section('js')
@include('modules.nur_ob.include.create_js')
@endsection
    ...
    <div class="col">
        ...
        <div class="card">
            ...
            <div class="card-header">
                <div class="row">
                    <div class="col">
                        <a href="{{ route('nur-obs.index') }}" class="btn btn-warning btn-sm"><i class="fas fa-backward mr-2"></i>All Data</a>
                        <a href="{{ route('nur-obs.show',$data['initId']) }}" class="btn btn-warning btn-sm"><i class="fas fa-backward mr-2"></i>Detail</a>
                        <span class="ml-3">
