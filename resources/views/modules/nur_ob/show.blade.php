...
@section('css')
@include('modules.nur_ob.include.show_css')
@endsection

@section('js')
@include('modules.nur_ob.include.show_js')
@endsection
            ...
            <div class="card-header">
                <div class="row">
                    <div class="col">
                        ...
                        <a href="{{ route('nur-obs.index') }}" class="btn btn-warning btn-sm has-ripple"><i class="fas fa-backward mr-2"></i>Back</a>
                    </div>
...
@include('modules.nur_ob.include.modal')
@endsection
