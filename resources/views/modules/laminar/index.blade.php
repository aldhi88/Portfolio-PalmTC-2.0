...
@section('css')
    @include('modules.laminar.include.index_css')
@endsection

@section('js')
    @include('modules.laminar.include.index_js')
    @include('modules.laminar.include.create_js')
    @include('modules.laminar.include.edit_js')
    @include('modules.laminar.include.delete_js')
@endsection
...
@include('modules.laminar.include.modal')
@endsection
